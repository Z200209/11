package com.example.console.filter;
...
public class CorsFilter implements Filter {
    ...
    // 允许的请求头
    private final String allowedHeaders = "Authorization, Content-Type, X-Requested-With, Accept";
    ...
    /**
     * 将通配符模式转换为域名前缀
     * 例如：http://localhost:* -> http://localhost
     */
